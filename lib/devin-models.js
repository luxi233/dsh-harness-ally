...
// models list 不可用(未登录判定 bug 或旧版本无此命令)时合并两条目录源:
// ACP configOptions 是官方列表(有 name/meta),但会漏掉一些 slug
// (如无档位的 swe-2 基础项);bin 缓存是账号级 slug 全集。取并集——
// ACP 条目优先,缓存独有的附在后面,再补 ACP currentValue。
